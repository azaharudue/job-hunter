...
2. Search the boards in `AGENTS.md` (Indeed, LinkedIn, StepStone, **kununu** at kununu.com/de/jobs + category pages like kununu.com/de/jobs/d-it-softwareentwicklung, join.com, jobijoba, jobborse24, **databerlin.net**, **freehire.me**, personio/workable/company career pages, startup boards) with varied keyword combos matching the tier list, e.g. "Applied AI Engineer", "LLM Engineer", "RAG Engineer", "AI Software Engineer", "Full-Stack Engineer Python React AI", "Backend Engineer FastAPI AI". kununu bonus: the kununu score and salary-check data give company-size and culture signals directly — use them for the company-fit score.
